// 4.12.2 dither_algorithm=2 alpha_dither=yes layout_rotation=0 opaque_image_format=RGB888 non_opaque_image_format=ARGB8888 section=ExtFlashSection extra_section=ExtFlashSection generate_png=no 0x4746c1d8
...
extern const unsigned char _realbackground[]; // BITMAP_REALBACKGROUND_ID = 2, Size: 800x480 pixels
...
const touchgfx::Bitmap::BitmapData bitmap_database[] =
{
    ...
    { _realbackground, 0, 800, 480, 0, 0, 800, (uint8_t)(touchgfx::Bitmap::RGB888) >> 3, 480, (uint8_t)(touchgfx::Bitmap::RGB888) & 0x7 }
};
